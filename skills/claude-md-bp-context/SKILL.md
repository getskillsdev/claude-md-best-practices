...
- If user approves a file edit, that counts as confirmation - advance to next item
- If no edit needed (item passes), still STOP and show findings before moving on
- Never auto-advance without user interaction
